...
export function Footer({
  ...
  const getHref = (link: FooterProps['columns'][0]['links'][0]['link']) => {
  ...
  return (
    <footer className="bg-muted/30 border-t border-foreground/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                {column.links && column.links.length > 0 && (
                  <ul className="space-y-2">
                    {column.links.map((linkItem) => {
                      const href = getHref(linkItem.link)
                      const isExternal = linkItem.link.linkType === 'external'
        ...
        <div className="mt-8 pt-8 border-t border-foreground/10 flex flex-col sm:flex-row justify-between items-center">
          {copyright && (
